 ...
 *
 * The mirror workflow dropped this when it overwrote FormatEntity.kt, which is why the restored
 * AppleMusicPlayer failed to resolve it. Re-added here rather than by reverting the whole file, so
 * that fileExtension() and exportMimeType() are kept.
 */
