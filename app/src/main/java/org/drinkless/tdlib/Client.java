 ...
 *
 * VENDORED TDLight Android binding, generated from
 * tdlight-team/tdlight @ 2b51b33c8a905be96c40508e68485f8a719e26a3
 * (TDLib 1.8.66 base, Boost Software License 1.0) by
 * .github/workflows/build-tdlight-android.yml — the same commit that
 * builds the runtime-downloaded libtdjni.so, so the TL schema always
 * matches the native library exactly.
 */
